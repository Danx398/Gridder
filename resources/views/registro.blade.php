...
<div class="container mt-5">
    <div class="row mt-5">
        ...
        <div class="col-4 shadow rounded mt-5 border">
            <h1 class="text-center mb-3 mt-3">Registro de nuevo usuario</h1>
            <form action="{{route('registrar')}}" method="post" autocomplete="off">
                ...
                <div class="d-flex justify-content-center">
                    <button class=" btn btn-outline-dark mb-3">Registrarse</button>
                </div>
            </form>
            <a class="d-flex justify-content-center mb-3" href="{{route('login')}}">Regresar</a>
        </div>
        <div class="col"></div>
    </div>
</div>
